...
# Используйте Step Over клавишу F8 для перехода к следующему шагу выполнения программы
# Посмотрите на консоль и на ход выполнения программы
# Приложите скриншот (изображение), написанного кода

print(f'Файл main.py изменён в соответствии с требованиями этого задания')